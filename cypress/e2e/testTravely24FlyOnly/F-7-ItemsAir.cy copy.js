  ...
  context('Test date on site', () => {
    ...
    newArrayTestItems.forEach((_item, i) => {
      ...
      it(`Test item #${i + 1} on site`, () => {
        ...
        cy.get(
          `#showedOtherFlights${i} [data-cy="leftTimeFrom"]`,
          {
            timeout: 30000,
          }
        ).then((html) => {
        ...
        cy.get(
          `#showedOtherFlights${i} [data-cy="leftTimeTo"]`,
          {
            timeout: 10000,
          }
        ).then((html) => {
        ...
        cy.get(
          `#showedOtherFlights${i} [data-cy="rightTimeFrom"]`,
          {
            timeout: 10000,
          }
        ).then((html) => {
        ...
        cy.get(
          `#showedOtherFlights${i} [data-cy="rightTimeTo"]`,
          {
            timeout: 10000,
          }
        ).then((html) => {
