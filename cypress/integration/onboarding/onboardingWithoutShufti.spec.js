...
describe("Onboarding register step", () => {
    ...
    it("Company Address", () => {
        cy.get("[data-cy=BusinessAddress-regAddress-address1-info")
            .click()
        cy.wait(1000);
        cy.get("[data-cy=BusinessAddress-infoModal-close]").click();
    ...
    it("Upload docs", () => {
        cy.get("[data-cy=UploadDocs-rules-info]").click();
        cy.wait(1000);
        cy.get("[data-cy=UploadDocs-modal-close]").click();
    ...
    it("Role In Company", () => {
        ...
        cy.get("[data-cy=RoleInCompany-dropzone]").attachFile("./assets/cypress-test.pdf");
        cy.get("[data-cy=RoleInCompany-dropzone-removeFile]").click();
        cy.wait(1000);
    ...
    it("Company Directors", () => {
        ...
        cy.get("[data-cy=Directors-firstName]")
            .click()
            .type("John");
        cy.get("[data-cy=Directors-lastName]")
            .click()
            .type("Doe");
        cy.get("[data-cy=Directors-email]")
            .click()
            .type("test@mail.com");
        cy.get("[data-cy=Directors-gender-dropdown]").click();
        cy.get("[data-cy=Directors-gender-item]")
            .first()
            .click();
    ...
    it("Shareholders", () => {
        cy.get("[data-cy=Shareholders-voteNo]").click();
