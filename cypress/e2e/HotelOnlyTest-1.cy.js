...
//   const URL =
// 	'https://www.travely24.com/de/tours/1414?hid=29248&period=2&adults=2&children&fa=PMI&sDate=2022-11-05&eDate=2022-11-07&productType=hotelonly&roomType=DBT.BL&boardType=BB&PT=hotelonly&flight=EW583|EW582|';
//   const ADULTS = '2';
...
//   const title = 'Mallorca - Soller, zauberhaftes Städtchen mit Bergpanorama';
  ...
  describe('Hotel only', () => {
	...
	it('TEST LowPriceHotelBeds AND MATCHING IN total-price BLOCK', () => {
	  cy.visit(
	...
	it('TEST lowPriseProductType AND MATCHING in .drop-tour-apartments-content-right BLOCK', () => {
	  ...
	  cy.get('.collapseCategory', { timeout: 20000 }).click({
		force: true,
		multiple: true,
	  });
